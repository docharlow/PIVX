...
In order to support loading of multiple wallets in sdc-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is sdc.cpp.
...
Changes to sdc.cpp
----------------------
sdc.cpp is the entry point into sdc-qt, and as such, will require some minor modifications to provide hooks for
