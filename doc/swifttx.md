...
This mechanism has been integrated into Bitcore-Node-SDC which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/SDC-Project/insight-api-sdc#web-socket-api](https://github.com/SDC-Project/insight-api-sdc#web-socket-api) 
* API: [https://github.com/SDC-Project/insight-api-sdc#swifttx-transactions](https://github.com/SDC-Project/insight-api-sdc#swifttx-transactions) 
...
By default, the SDC Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the SDC Core daemon:
