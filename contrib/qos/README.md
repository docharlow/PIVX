...
This means one can have an always-on sdcd instance running, and another local sdcd/sdc-qt instance which connects to this node and receives blocks from it.
