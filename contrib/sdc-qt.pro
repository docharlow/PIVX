...
RESOURCES += src/qt/sdc.qrc src/qt/sdc_locale.qrc

TRANSLATIONS += src/qt/locale/sdc_bg.ts \
                src/qt/locale/sdc_de.ts \
                src/qt/locale/sdc_en.ts \
                src/qt/locale/sdc_es.ts \
                src/qt/locale/sdc_fi.ts \
                src/qt/locale/sdc_fr.ts \
                src/qt/locale/sdc_it.ts \
                src/qt/locale/sdc_ja.ts \
                src/qt/locale/sdc_pl.ts \
                src/qt/locale/sdc_pt.ts \
                src/qt/locale/sdc_ru.ts \
                src/qt/locale/sdc_sk.ts \
                src/qt/locale/sdc_sv.ts \
                src/qt/locale/sdc_vi.ts \
                src/qt/locale/sdc_zh_CN.ts \
                src/qt/locale/sdc_zh_TW.ts
