Contributing to SDC Core
============================

The SDC Core project operates an open contributor model where anyone is
...
The following applies to code changes to the SDC Core project, and is not to be
confused with overall SDC Network Protocol consensus changes.

Whether a pull request is merged into SDC Core rests with the project merge
...
Patches that change SDC consensus rules are considerably more involved than
...
Where a patch set proposes to change the SDC consensus, it must have been
...
The project leader is the release manager for each SDC Core release.
