...
/* Sdc GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "SDC"
#define QAPP_ORG_DOMAIN "sdc.org"
#define QAPP_APP_NAME_DEFAULT "SDC-Qt"
#define QAPP_APP_NAME_TESTNET "SDC-Qt-testnet"
