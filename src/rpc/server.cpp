...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* SDC features */
        {"sdc", "masternode", &masternode, true, true, false},
        {"sdc", "listmasternodes", &listmasternodes, true, true, false},
        {"sdc", "getmasternodecount", &getmasternodecount, true, true, false},
        {"sdc", "masternodeconnect", &masternodeconnect, true, true, false},
        {"sdc", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"sdc", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"sdc", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"sdc", "masternodecurrent", &masternodecurrent, true, true, false},
        {"sdc", "masternodedebug", &masternodedebug, true, true, false},
        {"sdc", "startmasternode", &startmasternode, true, true, false},
        {"sdc", "createmasternodekey", &createmasternodekey, true, true, false},
        {"sdc", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"sdc", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"sdc", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"sdc", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"sdc", "getmasternodescores", &getmasternodescores, true, true, false},
        {"sdc", "mnbudget", &mnbudget, true, true, false},
        {"sdc", "preparebudget", &preparebudget, true, true, false},
        {"sdc", "submitbudget", &submitbudget, true, true, false},
        {"sdc", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"sdc", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"sdc", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"sdc", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"sdc", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"sdc", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"sdc", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"sdc", "checkbudgets", &checkbudgets, true, true, false},
        {"sdc", "mnsync", &mnsync, true, true, false},
        {"sdc", "spork", &spork, true, true, false},
        {"sdc", "getpoolinfo", &getpoolinfo, true, true, false},
...
{
    return "> sdc-cli " + methodname + " " + args + "\n";
}
